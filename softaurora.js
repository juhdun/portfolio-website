// SoftAurora Component - Vanilla JavaScript Implementation
// Converted from React (React Bits) to work with existing HTML/CSS/JS website
...
class SoftAurora {
  ...
  setupEventListeners() {
    ...
    if (this.options.enableMouseInteraction) {
      this.gl.canvas.addEventListener('mousemove', this.handleMouseMove);
      this.gl.canvas.addEventListener('mouseleave', this.handleMouseLeave);
    }
  }
  ...
  destroy() {
    ...
    if (this.options.enableMouseInteraction) {
      this.gl.canvas.removeEventListener('mousemove', this.handleMouseMove);
      this.gl.canvas.removeEventListener('mouseleave', this.handleMouseLeave);
    }
